...
export function Hero() {
  return (
    <header className="relative overflow-hidden px-5 pb-20 pt-12 sm:px-8 sm:pb-24 sm:pt-16 md:pb-28 md:pt-24">
      ...
      <div className="relative mx-auto max-w-xl text-center md:max-w-2xl lg:max-w-3xl">
        ...
        <h1 className="animate-fade-up mt-6 font-serif text-[1.85rem] font-semibold leading-[1.2] tracking-[-0.02em] text-[var(--ink)] opacity-0 [animation-delay:160ms] [animation-fill-mode:forwards] sm:text-[2.15rem] md:text-[2.35rem] lg:text-[2.55rem]">
          {LANDING_HERO.title}
        </h1>
        <p className="animate-fade-up mt-7 text-pretty text-base leading-[1.75] text-[var(--muted)] opacity-0 [animation-delay:240ms] [animation-fill-mode:forwards] sm:text-lg sm:leading-[1.8]">
        ...
        <div className="animate-fade-up mt-14 flex flex-col items-center gap-5 opacity-0 [animation-delay:320ms] [animation-fill-mode:forwards] sm:mt-16">
          ...
          <p className="max-w-[28ch] text-center text-sm leading-relaxed text-[var(--muted)] sm:text-[0.95rem] lg:max-w-[34ch]">
            💛 Às vezes, uma frase muda o dia inteiro.
          </p>
          {LANDING_HERO_PURPOSE_HINT ? (
            <p className="max-w-[38ch] text-center text-xs leading-relaxed text-[var(--muted)]/90 sm:text-[0.82rem] lg:max-w-[48ch]">
              {LANDING_HERO_PURPOSE_HINT}
            </p>
          ) : null}
        </div>
